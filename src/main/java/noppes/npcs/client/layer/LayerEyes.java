...
public class LayerEyes extends LayerInterface {
	...
	public void render(float par2, float par3, float par4, float par5, float par6, float par7) {
		if (this.playerdata.eyes.isEnabled()) {
			...
			GlStateManager.translate(0.0F,
					(float) ((this.playerdata.eyes.type == 1 ? 1 : 2) - this.playerdata.eyes.eyePos), 0.0F);
	...
	private void drawBrows() {
		...
		if (this.playerdata.eyes.browThickness > 0) {
			...
			this.drawRect(-3.0D, (double) (-5.0F + offsetY), -1.0D, (double) (-5.0F - f + offsetY),
					this.playerdata.eyes.browColor, 4.014D);
			this.drawRect(1.0D, (double) (-5.0F + offsetY), 3.0D, (double) (-5.0F - f + offsetY),
					this.playerdata.eyes.browColor, 4.014D);
		}
