...
public class ModelPlaneRenderer extends ModelRenderer {
	...
	public void addPlane(float par1, float par2, float par3, int par4, int par5, int par6, float f3,
			ModelPlaneRenderer.EnumPlanePosition pos) {
		this.cubeList.add(new ModelPlaneRenderer.ModelPlane(this, this.textureOffsetX, this.textureOffsetY, par1, par2,
				par3, par4, par5, par6, f3, pos));
	}
	...
	public class ModelPlane extends ModelBox {
		...
		public ModelPlane(ModelRenderer par1ModelRenderer, int textureOffsetX, int textureOffsetY, float par4,
				float par5, float par6, int par7, int par8, int par9, float par10,
				ModelPlaneRenderer.EnumPlanePosition position) {
			...
			if (position == ModelPlaneRenderer.EnumPlanePosition.LEFT) {
				this.quad = new TexturedQuad(new PositionTextureVertex[] { var19, var15, var16, var20 }, textureOffsetX,
			...
			if (position == ModelPlaneRenderer.EnumPlanePosition.TOP) {
				this.quad = new TexturedQuad(new PositionTextureVertex[] { var19, var18, var23, var15 }, textureOffsetX,
			...
			if (position == ModelPlaneRenderer.EnumPlanePosition.BACK) {
				this.quad = new TexturedQuad(new PositionTextureVertex[] { var15, var23, var17, var16 }, textureOffsetX,
