...
public class SubGuiNpcAvailabilityScoreboard extends SubGuiInterface implements ITextfieldListener {
	...
	public void initGui() {
		...
		this.addTextField(
				new GuiNpcTextField(10, this, this.guiLeft + 4, y, 140, 20, this.availabitily.scoreboardObjective));
		this.addButton(new GuiNpcButton(0, this.guiLeft + 148, y, 90, 20,
				new String[] { "availability.smaller", "availability.equals", "availability.bigger" },
				this.availabitily.scoreboardType.ordinal()));
		this.addTextField(
				new GuiNpcTextField(20, this, this.guiLeft + 244, y, 60, 20, this.availabitily.scoreboardValue + ""));
		this.getTextField(20).numbersOnly = true;
		y += 23;
		this.addTextField(
				new GuiNpcTextField(11, this, this.guiLeft + 4, y, 140, 20, this.availabitily.scoreboard2Objective));
		this.addButton(new GuiNpcButton(1, this.guiLeft + 148, y, 90, 20,
				new String[] { "availability.smaller", "availability.equals", "availability.bigger" },
				this.availabitily.scoreboard2Type.ordinal()));
		this.addTextField(
				new GuiNpcTextField(21, this, this.guiLeft + 244, y, 60, 20, this.availabitily.scoreboard2Value + ""));
