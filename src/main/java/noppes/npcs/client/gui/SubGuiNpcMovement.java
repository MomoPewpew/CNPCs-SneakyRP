...
public class SubGuiNpcMovement extends SubGuiInterface implements ITextfieldListener {
	...
	public void initGui() {
		...
		y += 22;
		this.addButton(new GuiNpcButton(15, var10004, y, 100, 20,
		...
		if (this.ai.getMovingType() == 1) {
			...
			y += 22;
			this.addButton(new GuiNpcButton(5, var10004, y, 50, 20, new String[] { "gui.no", "gui.yes" },
			...
			y += 22;
			this.addButton(new GuiNpcButton(9, var10004, y, 80, 20, new String[] { "gui.no", "gui.yes" },
			...
			this.addTextField(
					new GuiNpcTextField(8, this, this.guiLeft + 135, y, 24, 20, (int) this.ai.bodyOffsetY + ""));
			...
			this.addTextField(
					new GuiNpcTextField(9, this, this.guiLeft + 171, y, 24, 20, (int) this.ai.bodyOffsetZ + ""));
			this.getTextField(9).numbersOnly = true;
			this.getTextField(9).setMinMaxDefault(0, 10, 5);
			var10004 = this.guiLeft + 80;
			y += 22;
			this.addButton(new GuiNpcButton(3, var10004, y, 100, 20,
			...
			if (this.ai.animationType != 2) {
				var10004 = this.guiLeft + 80;
				y += 22;
				this.addButton(new GuiNpcButton(4, var10004, y, 80, 20,
		...
		if (this.ai.getMovingType() != 0) {
			var10004 = this.guiLeft + 80;
			y += 22;
			this.addButton(new GuiNpcButton(12, var10004, y, 100, 20,
		...
		if (this.ai.getMovingType() == 2) {
			var10004 = this.guiLeft + 80;
			y += 22;
			this.addButton(new GuiNpcButton(8, var10004, y, 80, 20, new String[] { "ai.looping", "ai.backtracking" },
		...
		var10004 = this.guiLeft + 100;
		y += 22;
		this.addButton(new GuiNpcButton(13, var10004, y, 50, 20, new String[] { "gui.no", "gui.yes" },
