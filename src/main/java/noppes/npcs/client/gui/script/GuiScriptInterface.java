	...
	public void initGui() {
		...
		if (this.activeTab > 0) {
			...
			GuiTextArea ta = new GuiTextArea(2, this.guiLeft + 1 + yoffset, this.guiTop + yoffset,
					this.xSize - 108 - yoffset, (int) ((double) this.ySize * 0.96D) - yoffset * 2,
			...
			GuiTextArea ta = new GuiTextArea(2, this.guiLeft + 4 + yoffset, this.guiTop + 6 + yoffset,
					this.xSize - 160 - yoffset, (int) ((float) this.ySize * 0.92F) - yoffset * 2,
					this.getConsoleText());
			ta.enabled = false;
			this.add(ta);
			...
			this.addButton(new GuiNpcButton(103, left + 60, this.guiTop + 10, 80, 20,
			...
			this.addButton(new GuiNpcButton(104, left + 60, this.guiTop + 31, 50, 20,
