...
public class GuiNpcSlider extends GuiButton {
	...
	public void mouseDragged(Minecraft mc, int par2, int par3) {
		if (this.visible) {
			...
			this.drawTexturedModalRect(this.x + (int) (this.sliderValue * (float) (this.width - 8)), this.y, 0, 66, 4,
					20);
			this.drawTexturedModalRect(this.x + (int) (this.sliderValue * (float) (this.width - 8)) + 4, this.y, 196,
					66, 4, 20);
		}
	}
