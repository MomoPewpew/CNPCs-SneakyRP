...
public class GuiMenuSideButton extends GuiNpcButton {
	public static final ResourceLocation resource = new ResourceLocation("customnpcs",
			"textures/gui/menusidebutton.png");
	...
	public void drawButton(Minecraft minecraft, int i, int j, float partialTicks) {
		if (this.visible) {
			...
			if (this.active) {
				this.drawCenteredString(fontrenderer, text, this.x + width / 2, this.y + (this.height - 8) / 2,
						16777120);
