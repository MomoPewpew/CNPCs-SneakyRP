...
public class GuiNpcMobSpawnerMounter extends GuiNPCInterface implements IGuiData {
	...
	public void initGui() {
		...
		this.addTextField(
				new GuiNpcTextField(1, this, this.fontRenderer, this.guiLeft + 4, this.guiTop + 4, 165, 20, search));
	...
	private NBTTagCompound getCompound() {
		...
		if (sel == null) {
			...
			Entity entity = EntityList.createEntityByIDFromName(new ResourceLocation(sel),
	...
	protected void actionPerformed(GuiButton guibutton) {
		...
		if (id == 1) {
			...
			if (compound != null) {
				compound.setTag("Pos", this.newDoubleNBTList((double) this.posX + 0.5D, (double) (this.posY + 1),
						(double) this.posZ + 0.5D));
