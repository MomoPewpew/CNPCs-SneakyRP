...
public class GuiNpcRedstoneBlock extends GuiNPCInterface implements IGuiData {
	...
	public void initGui() {
		...
		if (this.tile.isDetailed) {
			this.addLabel(new GuiNpcLabel(0, I18n.translateToLocal("bard.ondistance") + " X:", this.guiLeft + 1,
					this.guiTop + 76, 16777215));
			...
			this.addLabel(new GuiNpcLabel(3, I18n.translateToLocal("bard.offdistance") + " X:", this.guiLeft - 3,
					this.guiTop + 99, 16777215));
