...
public class SubGuiNpcAvailabilityDialog extends SubGuiInterface implements ISubGuiListener {
	...
	public void initGui() {
		...
		this.addButton(new GuiNpcButton(0, this.guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				this.availabitily.dialogAvailable.ordinal()));
		...
		y += 23;
		this.addButton(new GuiNpcButton(1, this.guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				this.availabitily.dialog2Available.ordinal()));
		...
		y += 23;
		this.addButton(new GuiNpcButton(2, this.guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				this.availabitily.dialog3Available.ordinal()));
		...
		y += 23;
		this.addButton(new GuiNpcButton(3, this.guiLeft + 4, y, 50, 20,
				new String[] { "availability.always", "availability.after", "availability.before" },
				this.availabitily.dialog4Available.ordinal()));
