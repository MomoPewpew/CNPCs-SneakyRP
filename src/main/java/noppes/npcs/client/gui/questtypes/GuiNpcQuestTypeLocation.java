...
public class GuiNpcQuestTypeLocation extends SubGuiInterface implements ITextfieldListener {
	...
	public void initGui() {
		super.initGui();
		this.addLabel(new GuiNpcLabel(0, "Fill in the name of your Location Quest Block", this.guiLeft + 4,
				this.guiTop + 50));
		this.addTextField(new GuiNpcTextField(0, this, this.fontRenderer, this.guiLeft + 4, this.guiTop + 70, 180, 20,
				this.quest.location));
		this.addTextField(new GuiNpcTextField(1, this, this.fontRenderer, this.guiLeft + 4, this.guiTop + 92, 180, 20,
				this.quest.location2));
		this.addTextField(new GuiNpcTextField(2, this, this.fontRenderer, this.guiLeft + 4, this.guiTop + 114, 180, 20,
				this.quest.location3));
