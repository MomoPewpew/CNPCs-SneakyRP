...
public class SubGuiNpcAvailability extends SubGuiInterface
	...
	public void initGui() {
		...
		this.addButton(
				new GuiNpcButton(2, this.guiLeft + 34, this.guiTop + 58, 180, 20, "availability.selectscoreboard"));
		this.addButton(new GuiNpcButton(20, this.guiLeft + 4, this.guiTop + 104, 50, 20,
				new String[] { "availability.always", "availability.is", "availability.isnot" },
				this.availabitily.factionAvailable.ordinal()));
		this.addButton(new GuiNpcButton(22, this.guiLeft + 56, this.guiTop + 104, 60, 20,
				new String[] { "faction.friendly", "faction.neutral", "faction.unfriendly" },
				this.availabitily.factionStance.ordinal()));
		this.addButton(
				new GuiNpcButton(21, this.guiLeft + 118, this.guiTop + 104, 110, 20, "availability.selectfaction"));
		...
		this.addButton(new GuiNpcButton(24, this.guiLeft + 4, this.guiTop + 126, 50, 20,
				new String[] { "availability.always", "availability.is", "availability.isnot" },
				this.availabitily.faction2Available.ordinal()));
		this.addButton(new GuiNpcButton(27, this.guiLeft + 56, this.guiTop + 126, 60, 20,
				new String[] { "faction.friendly", "faction.neutral", "faction.unfriendly" },
				this.availabitily.faction2Stance.ordinal()));
		this.addButton(
				new GuiNpcButton(25, this.guiLeft + 118, this.guiTop + 126, 110, 20, "availability.selectfaction"));
		...
		this.addButton(new GuiNpcButton(50, this.guiLeft + 50, this.guiTop + 148, 150, 20,
				new String[] { "availability.wholeday", "availability.night", "availability.day" },
				this.availabitily.daytime.ordinal()));
		this.addLabel(new GuiNpcLabel(51, "availability.minlevel", this.guiLeft + 4, this.guiTop + 175));
		this.addTextField(new GuiNpcTextField(51, this, this.fontRenderer, this.guiLeft + 50, this.guiTop + 170, 90, 20,
