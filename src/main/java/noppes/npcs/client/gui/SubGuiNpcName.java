...
public class SubGuiNpcName extends SubGuiInterface implements ITextfieldListener {
     ...
     public void initGui() {
          ...
          y += 22;
          this.addButton(new GuiButtonBiDirectional(2, var10004, y, 120, 20, new String[]{"markov.gender.either", "markov.gender.male", "markov.gender.female"}, this.display.getMarkovGender()));
