...
public class GuiMailbox extends GuiNPCInterface implements IGuiData, ICustomScrollListener, GuiYesNoCallback {
	...
	public void initGui() {
		...
		if (this.selected != null) {
			this.addLabel(new GuiNpcLabel(3, I18n.translateToLocal("mailbox.sender") + ":", this.guiLeft + 170,
					this.guiTop + 6));
			this.addLabel(new GuiNpcLabel(1, this.selected.sender, this.guiLeft + 174, this.guiTop + 18));
			this.addLabel(new GuiNpcLabel(2,
					I18n.translateToLocalFormatted("mailbox.timesend", new Object[] { this.getTimePast() }),
					this.guiLeft + 174, this.guiTop + 30));
		}
	...
	private String getTimePast() {
		...
		if (this.selected.timePast > 86400000L) {
			...
			return minutes == 1 ? minutes + " " + I18n.translateToLocal("mailbox.day")
					: minutes + " " + I18n.translateToLocal("mailbox.days");
		} else if (this.selected.timePast > 3600000L) {
			minutes = (int) (this.selected.timePast / 3600000L);
			return minutes == 1 ? minutes + " " + I18n.translateToLocal("mailbox.hour")
					: minutes + " " + I18n.translateToLocal("mailbox.hours");
		} else {
			minutes = (int) (this.selected.timePast / 60000L);
			return minutes == 1 ? minutes + " " + I18n.translateToLocal("mailbox.minutes")
					: minutes + " " + I18n.translateToLocal("mailbox.minutes");
		}
	}
