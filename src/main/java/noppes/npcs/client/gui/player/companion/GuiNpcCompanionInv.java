     ...
     protected void func_146976_a(float f, int xMouse, int yMouse) {
          ...
          if (this.role.getTalentLevel(EnumCompanionTalent.ARMOR) > 0) {
               for(size = 0; size < 4; ++size) {
                    this.drawTexturedModalRect(this.field_147003_i + 5, this.field_147009_r + 7 + size * 18, 0, 0, 18, 18);
               }
          }

          if (this.role.getTalentLevel(EnumCompanionTalent.SWORD) > 0) {
               this.drawTexturedModalRect(this.field_147003_i + 78, this.field_147009_r + 16, 0, this.npc.inventory.weapons.get(0) == null ? 18 : 0, 18, 18);
          }
          ...
          if (this.role.talents.containsKey(EnumCompanionTalent.INVENTORY)) {
               ...
               for(int i = 0; i < size; ++i) {
                    this.drawTexturedModalRect(this.field_147003_i + 113 + i % 3 * 18, this.field_147009_r + 7 + i / 3 * 18, 0, 0, 18, 18);
               }
          }
