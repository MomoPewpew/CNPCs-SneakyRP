...
public class GuiNpcCarpentryBench extends GuiContainerNPCInterface {
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		this.fontRenderer.drawString(title, this.guiLeft + 4, this.guiTop + 4,
				CustomNpcResourceListener.DefaultTextColor);
		this.fontRenderer.drawString(I18n.translateToLocal("container.inventory"), this.guiLeft + 4, this.guiTop + 87,
				CustomNpcResourceListener.DefaultTextColor);
	}
