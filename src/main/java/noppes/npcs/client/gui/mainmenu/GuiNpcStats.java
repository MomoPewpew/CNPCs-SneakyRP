...
public class GuiNpcStats extends GuiNPCInterface2 implements ITextfieldListener, IGuiData {
	...
	public void initGui() {
		...
		this.addTextField(new GuiNpcTextField(1, this, this.fontRenderer, this.guiLeft + 220, y, 50, 18,
		...
		this.addButton(new GuiNpcButton(8, this.guiLeft + 355, y, 56, 20,
		...
		var10004 = this.guiLeft + 82;
		y += 34;
		this.addButton(new GuiNpcButton(4, var10004, y, 56, 20, new String[] { "gui.no", "gui.yes" },
				this.npc.isImmuneToFire() ? 1 : 0));
		...
		y += 22;
		this.addTextField(
				(new GuiNpcTextField(16, this, var10005, y, 56, 20, this.stats.combatRegen + "")).setNumbersOnly());
