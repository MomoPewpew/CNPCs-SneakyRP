...
public class GuiCreationParts extends GuiCreationScreenInterface implements ITextfieldListener, ICustomScrollListener {
	...
	public GuiCreationParts(EntityNPCInterface npc) {
		...
		this.parts = new GuiCreationParts.GuiPart[] {
				(new GuiCreationParts.GuiPart(EnumParts.EARS))
						.setTypes(new String[] { "gui.none", "gui.normal", "ears.bunny" }),
				new GuiCreationParts.GuiPartHorns(), new GuiCreationParts.GuiPartHair(),
				(new GuiCreationParts.GuiPart(EnumParts.MOHAWK))
						.setTypes(new String[] { "gui.none", "1", "2" }).noPlayerOptions(),
				new GuiCreationParts.GuiPartSnout(), new GuiCreationParts.GuiPartBeard(),
				(new GuiCreationParts.GuiPart(EnumParts.FIN))
						.setTypes(new String[] { "gui.none", "fin.shark", "fin.reptile" }),
				(new GuiCreationParts.GuiPart(EnumParts.BREASTS)).setTypes(new String[] { "gui.none", "1", "2", "3" })
						.noPlayerOptions(),
				new GuiCreationParts.GuiPartWings(), new GuiCreationParts.GuiPartClaws(),
				(new GuiCreationParts.GuiPart(EnumParts.SKIRT)).setTypes(new String[] { "gui.none", "gui.normal" }),
				new GuiCreationParts.GuiPartLegs(), new GuiCreationParts.GuiPartTail(),
				new GuiCreationParts.GuiPartEyes(), new GuiCreationParts.GuiPartParticles() };
		this.active = 2;
	...
	class GuiPartEyes extends GuiCreationParts.GuiPart {
		...
		public int initGui() {
			...
			if (this.data != null && this.eyes.isEnabled()) {
				...
				y += 25;
				GuiCreationParts.this.addButton(new GuiButtonBiDirectional(37, var10004, y, 100, 20,
						new String[] { I18n.translateToLocal("gui.down") + "x2", "gui.down", "gui.normal", "gui.up" },
						this.eyes.eyePos + 1));
				GuiCreationParts.this.addLabel(
		...
		protected void actionPerformed(GuiButton btn) {
			...
			if (btn.id == 35) {
				GuiCreationParts.this
						.setSubGui(new GuiModelColor(GuiCreationParts.this, this.eyes.browColor, (color) -> {
			...
			if (btn.id == 36) {
				GuiCreationParts.this
						.setSubGui(new GuiModelColor(GuiCreationParts.this, this.eyes.skinColor, (color) -> {
