...
public class GuiNpcCompanion extends GuiNPCInterface2 implements ITextfieldListener, ISliderListener {
	...
	public void initGui() {
		...
		y += 22;
		this.addButton(new GuiNpcButton(2, var10004, y, 90, 20, new String[] { "gui.no", "gui.yes" },
				this.role.canAge ? 1 : 0));
		...
		this.addSlider(new GuiNpcSlider(this, 10, this.guiLeft + 30, y + 2, 100, 20,
				(float) this.role.getExp(EnumCompanionTalent.INVENTORY) / 5000.0F));
		...
		this.addSlider(new GuiNpcSlider(this, 11, this.guiLeft + 30, y + 2, 100, 20,
				(float) this.role.getExp(EnumCompanionTalent.ARMOR) / 5000.0F));
		var10005 = this.guiLeft + 4;
		y += 26;
		...
		this.addSlider(new GuiNpcSlider(this, 12, this.guiLeft + 30, y + 2, 100, 20,
				(float) this.role.getExp(EnumCompanionTalent.SWORD) / 5000.0F));
