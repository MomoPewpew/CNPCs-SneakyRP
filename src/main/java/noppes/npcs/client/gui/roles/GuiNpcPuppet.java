...
public class GuiNpcPuppet extends GuiNPCInterface implements ISliderListener, ICustomScrollListener {
	...
	public void initGui() {
		...
		y += 14;
		this.addButton(new GuiNpcButton(30, var10004, y, 60, 20, new String[] { "gui.yes", "gui.no" },
		...
		y += 22;
		this.addButton(new GuiNpcButton(31, var10004, y, 60, 20, new String[] { "gui.yes", "gui.no" },
				this.job.whileMoving ? 0 : 1));
		this.addLabel(new GuiNpcLabel(31, "puppet.walking", this.guiLeft + 10, y + 5, 16777215));
		var10004 = this.guiLeft + 110;
		y += 22;
		this.addButton(new GuiNpcButton(32, var10004, y, 60, 20, new String[] { "gui.yes", "gui.no" },
				this.job.whileAttacking ? 0 : 1));
		this.addLabel(new GuiNpcLabel(32, "puppet.attacking", this.guiLeft + 10, y + 5, 16777215));
		var10004 = this.guiLeft + 110;
		y += 22;
		this.addButton(new GuiNpcButton(33, var10004, y, 60, 20, new String[] { "gui.yes", "gui.no" },
				this.job.animate ? 0 : 1));
