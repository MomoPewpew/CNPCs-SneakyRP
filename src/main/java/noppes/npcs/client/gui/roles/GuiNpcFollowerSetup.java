...
public class GuiNpcFollowerSetup extends GuiContainerNPCInterface2 {
	...
	public void initGui() {
		...
		this.addTextField(new GuiNpcTextField(3, this, this.fontRenderer, this.guiLeft + 100, this.guiTop + 6, 286, 20,
				this.role.dialogHire));
		this.addTextField(new GuiNpcTextField(4, this, this.fontRenderer, this.guiLeft + 100, this.guiTop + 30, 286, 20,
