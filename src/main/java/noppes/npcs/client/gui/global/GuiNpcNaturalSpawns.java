...
public class GuiNpcNaturalSpawns extends GuiNPCInterface2
	...
	private void showSpawn() {
		...
		this.addSlider(new GuiNpcSlider(this, 4, this.guiLeft + 4, this.guiTop + 47, 180, 20,
				(float) this.spawn.itemWeight / 100.0F));
	...
	public void mouseDragged(GuiNpcSlider guiNpcSlider) {
		guiNpcSlider.displayString = I18n.translateToLocal("spawning.weightedChance") + ": "
