...
public class GuiNPCManageFactions extends GuiNPCInterface2
	...
	public void initGui() {
		...
		if (this.faction.id != -1) {
			this.addTextField(
					new GuiNpcTextField(0, this, this.guiLeft + 40, this.guiTop + 4, 136, 20, this.faction.name));
			...
			this.addButton(new GuiNpcButton(3, this.guiLeft + 100, this.guiTop + 70, 45, 20,
			...
			this.addButton(new GuiNpcButton(4, this.guiLeft + 100, this.guiTop + 92, 45, 20,
