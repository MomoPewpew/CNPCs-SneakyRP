               ...
               if (type == EnumPacketServer.LinkedAdd) {
                    ...
                    if (type == EnumPacketServer.BankGet) {
                         ...
                         if (type == EnumPacketServer.RemoteMainMenu) {
                              entity = player.field_70170_p.func_73045_a(buffer.readInt());
                                                  ...
                                                  if (type == EnumPacketServer.DialogSave) {
                                                       ...
                                                       if (type == EnumPacketServer.DialogRemove) {
                                                            ...
                                                            if (type == EnumPacketServer.QuestOpenGui) {
                                                                 ...
                                                                 player.openGui(CustomNpcs.instance, t, player.field_70170_p, 0, 0, 0);
                                                                           ...
                                                                           if (type == EnumPacketServer.TransportRemove) {
                                                                                ...
                                                                                if (type == EnumPacketServer.FactionSave) {
                                                                                     ...
                                                                                     if (type == EnumPacketServer.FactionRemove) {
                                                                                          ...
                                                                                          player.openGui(CustomNpcs.instance, EnumGuiType.PlayerMailman.ordinal(), player.field_70170_p, 1, 0, 0);
                                                                                     } else {
                                                                                          boolean bo;
                                                                                          if (type == EnumPacketServer.TransformSave) {
                                                                                               ...
                                                                                               if (type == EnumPacketServer.TraderMarketSave) {
                                                                                                    ...
                                                                                                    entity = EntityList.func_75615_a(Server.readNBT(buffer), player.field_70170_p);
                                                                                                    ...
                                                                                                    Entity entity = NoppesUtilServer.spawnClone(compound, (double)t + 0.5D, (double)(y + 1), (double)z + 0.5D, player.field_70170_p);
                                                                                                    if (entity == null) {
                                                                                                    ...
                                                                                                    if (type == EnumPacketServer.MobSpawner) {
                                                                                                         ...
                                                                                                         if (type == EnumPacketServer.CloneList) {
                                                                                                              ...
                                                                                                              if (type == EnumPacketServer.ScriptBlockDataGet) {
                                                                                                                   tile = player.field_70170_p.func_175625_s(new BlockPos(buffer.readInt(), buffer.readInt(), buffer.readInt()));
                                                                                                                   ...
                                                                                                                   if (type == EnumPacketServer.GetTileEntity) {
                                                                                                                        ...
                                                                                                                        if (type == EnumPacketServer.SchematicsTile) {
                                                                                                                             pos = new BlockPos(buffer.readInt(), buffer.readInt(), buffer.readInt());
                                                                                                                             tile = (TileBuilder)player.field_70170_p.func_175625_s(pos);
                                                                                                                             if (tile == null) {
                                                                                                                                  return;
                                                                                                                             }
                                                                                                                             ...
                                                                                                                             if (player.field_71070_bA instanceof ContainerCustomGui) {
                                                                                                                                  ...
                                                                                                                                  EventHooks.onCustomGuiButton((PlayerWrapper)NpcAPI.Instance().getIEntity(player), ((ContainerCustomGui)player.field_71070_bA).customGui, buffer.readInt());
                                                                                                                             }
                                                                                                                        } else if (type == EnumPacketServer.CustomGuiSlotChange) {
                                                                                                                             if (player.field_71070_bA instanceof ContainerCustomGui) {
                                                                                                                                  ((ContainerCustomGui)player.field_71070_bA).customGui.fromNBT(Server.readNBT(buffer));
                                                                                                                                  EventHooks.onCustomGuiSlot((PlayerWrapper)NpcAPI.Instance().getIEntity(player), ((ContainerCustomGui)player.field_71070_bA).customGui, buffer.readInt());
                                                                                                                             }
                                                                                                                        } else if (type == EnumPacketServer.CustomGuiScrollClick && player.field_71070_bA instanceof ContainerCustomGui) {
                                                                                                                             ((ContainerCustomGui)player.field_71070_bA).customGui.fromNBT(Server.readNBT(buffer));
                                                                                                                             EventHooks.onCustomGuiScrollClick((PlayerWrapper)NpcAPI.Instance().getIEntity(player), ((ContainerCustomGui)player.field_71070_bA).customGui, buffer.readInt(), buffer.readInt(), CustomGuiController.readScrollSelection(buffer), buffer.readBoolean());
                                                                                                                        }
                                                                                                                   }
                                                                                                              }
                                                                                                         }
