...
public class ProjectileWrapper extends ThrowableWrapper implements IProjectile {
	...
	public void setHeading(IEntity entity) {
		this.setHeading(entity.getX(),
				entity.getMCEntity().getEntityBoundingBox().minY + (double) (entity.getHeight() / 2.0F), entity.getZ());
	}
	...
	public void setHeading(float yaw, float pitch) {
		...
		double varX = (double) (-MathHelper.sin(yaw / 180.0F * 3.1415927F)
				* MathHelper.cos(pitch / 180.0F * 3.1415927F));
		double varZ = (double) (MathHelper.cos(yaw / 180.0F * 3.1415927F)
				* MathHelper.cos(pitch / 180.0F * 3.1415927F));
