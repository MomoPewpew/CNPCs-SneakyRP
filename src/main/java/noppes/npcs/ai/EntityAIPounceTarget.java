...
public class EntityAIPounceTarget extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if (!this.npc.onGround) {
			...
			if (this.leapTarget != null && this.npc.getEntitySenses().canSee(this.leapTarget)) {
				return !this.npc.isInRange(this.leapTarget, 4.0D) && this.npc.isInRange(this.leapTarget, 8.0D)
	...
	public void startExecuting() {
		...
		this.npc.motionX = (double) (MathHelper.sin(yaw / 180.0F * 3.1415927F)
				* MathHelper.cos(angle / 180.0F * 3.1415927F));
		this.npc.motionZ = (double) (MathHelper.cos(yaw / 180.0F * 3.1415927F)
				* MathHelper.cos(angle / 180.0F * 3.1415927F));
