     ...
     public boolean func_75250_a() {
          if (this.npc.func_70681_au().nextFloat() < this.field_75331_e && !this.npc.isInteracting()) {
               ...
               if (this.watchedClass == EntityPlayer.class) {
                    this.closestEntity = this.npc.field_70170_p.func_72890_a(this.npc, (double)this.field_75333_c);
               } else {
                    this.closestEntity = this.npc.field_70170_p.func_72857_a(this.watchedClass, this.npc.func_174813_aQ().func_72314_b((double)this.field_75333_c, 3.0D, (double)this.field_75333_c), this.npc);
