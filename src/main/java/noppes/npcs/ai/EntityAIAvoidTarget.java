     ...
     public boolean shouldExecute() {
          ...
          if (target == null) {
               ...
               if (!this.npc.getEntitySenses().canSee(this.closestLivingEntity) && this.npc.ais.directLOS) {
                    ...
                    if (var2 == null) {
                         return false;
                    } else if (this.closestLivingEntity.getDistanceSq(var2.field_72450_a, var2.field_72448_b, var2.field_72449_c) < this.closestLivingEntity.getDistanceSq(this.npc)) {
                         return false;
                    } else if (this.npc.ais.tacticalVariant == 3 && var4) {
                         return false;
                    } else {
                         this.entityPathEntity = this.entityPathNavigate.getPathToXYZ(var2.field_72450_a, var2.field_72448_b, var2.field_72449_c);
