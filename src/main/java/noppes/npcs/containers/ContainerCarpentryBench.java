...
public class ContainerCarpentryBench extends Container {
     ...
     public boolean canInteractWith(EntityPlayer par1EntityPlayer) {
          return this.worldObj.getBlockState(this.pos).getBlock() == CustomItems.carpentyBench && par1EntityPlayer.getDistanceSq((double)this.pos.getX() + 0.5D, (double)this.pos.getY() + 0.5D, (double)this.pos.getZ() + 0.5D) <= 64.0D;
     }
